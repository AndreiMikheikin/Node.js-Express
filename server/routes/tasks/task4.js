...
router.get('/success', async (req, res) => {
  ...
  if (!hash) return res.redirect('/task4/submit');
  ...
  try {
    ...
    if (!userData) return res.redirect('/task4/submit');
    ...
    console.error('Ошибка при обработке success:', err);
    res.redirect('/task4/submit');
  }
});
